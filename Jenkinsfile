pipeline {
    ...
    environment {
        ...
        DOCKER_IMAGE = 'cithit/chhetrrb'                                   //<-----change this to your MiamiID!
        IMAGE_TAG = "build-${BUILD_NUMBER}"
        GITHUB_URL = 'https://github.com/ratnac101/225-lab4-2.git'     //<-----change this to match this new repository!
        KUBECONFIG = credentials('chhetrrb-225')                           //<-----change this to match your kubernetes credentials (MiamiID-225)! 
    }
        ...
        stage ("Run Security Checks") {
            steps {
                ...
                sh '''
                    ...
                    -e HOME=${WORKSPACE} \
                    -e BURP_START_URL=http://10.43.252.39 \
